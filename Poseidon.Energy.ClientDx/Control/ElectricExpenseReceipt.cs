...
namespace Poseidon.Energy.ClientDx
{
    ...
    /// 电费支出单据管理控件
    /// </summary>
    public partial class ElectricExpenseReceipt : DevExpress.XtraEditors.XtraUserControl
    {
        #region Field
        /// <summary>
        /// 当前关联账户
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            ChildFormManage.ShowDialogForm(typeof(FrmExpenseElectricAdd), new object[] { this.currentAccount.Id });
            LoadReceipts();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            ChildFormManage.ShowDialogForm(typeof(FrmExpenseElectricEdit), new object[] { expense.Id, this.currentAccount.Id });
            LoadReceipts();
        }
