...
namespace Poseidon.Energy.Core.BL
{
    ...
    public class PopulationBusiness : AbstractBusiness<Population>
    {
        ...
        public void Create(Population entity, ILoginUser user)
        {
        ...
        /// <param name="user">操作用户</param>
        /// <returns></returns>
        public (bool success, string errorMessage) Update(Population entity, ILoginUser user)
        {
            entity.UpdateBy = new UpdateStamp
            {
                UserId = user.Id,
        ...
        /// <param name="entity">实体对象</param>
        /// <returns></returns>
        public override (bool success, string errorMessage) Delete(Population entity)
        {
            // delete the records
            PopulationRecordBusiness recordBusiness = new PopulationRecordBusiness();
