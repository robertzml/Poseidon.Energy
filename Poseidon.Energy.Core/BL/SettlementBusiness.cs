...
namespace Poseidon.Energy.Core.BL
{
    ...
    public class SettlementBusiness : AbstractBusiness<Settlement>
    {
        ...
        /// <returns></returns>
        public Settlement Create(Settlement entity, ILoginUser user)
        {
        ...
        /// <param name="user">操作用户</param>
        /// <returns></returns>
        public (bool success, string errorMessage) Update(Settlement entity, ILoginUser user)
        {
            entity.UpdateBy = new UpdateStamp
            {
                UserId = user.Id,
        ...
        /// <param name="entity">实体对象</param>
        /// <returns></returns>
        public override (bool success, string errorMessage) Delete(Settlement entity)
        {
            // delete the records
